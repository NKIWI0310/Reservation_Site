var chartData = {
  ...
  barCircleWeb: [
    { index: 0.3, value: 313588490, fill: "#231F20", label: "WebMD Health" },
...
function animateBarCircleChart() {
  setTimeout(function () {
    drawBarCircleChart(
  ...
  setTimeout(function () {
    drawBarCircleChart(
      chartData.barCircleMobile,
      "#circleBar-mobile-chart",
      "#circleBar-mobile-values",
